...
$action = "?m={$gModule}&amp;p=fileeditp&amp;file={$uniqueName}&amp;au={$owner}";
	...
	<div class='settingsWrapperWide'>
		<div class='settingsLeftAdmin'>
			<p class='settings'>Namn:</p>
		</div>
		<div class='settingsMiddle'>
			<input type='text' name='name' value='{$name}' autofocus  size='35' {$editable} class='settingsForm' />
		</div>
		<div class='settingsLeftAdmin'>
	...
	<div class='settingsWrapperWide'>
		...
		<div class='settingsMiddle'>
			<input type='text' name='uniqueName' value='{$uniqueName}' size='35' readonly class='settingsForm'/>
		</div>
		<div class='settingsLeftAdmin'>
	...
	<div class='settingsWrapperWide'>
		...
		<div class='settingsMiddle'>
			<input type='text' name='owner' value='{$owner}' disabled size='35' class='settingsForm'/>
		</div>
		<div class='settingsLeftAdmin'>
	...
	<div class='settingsWrapperWide'>
		...
		<div class='settingsMiddle'>
			<textarea cols='30' rows='3' disabled>{$path}</textarea>
		</div>
		<div class='settingsMiddle'>
